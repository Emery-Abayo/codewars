...
//  lastName/LastName (defaults to "Doe" if not set), age/Age (defaults to 0 if not set) and 
// gender/Gender (defaults to "Male" if not set). These should be stored in this.firstName/this.FirstName, 
...
// and returns "Welcome to Planet Earth raceName". For example, if the race name is "Martians", 
...
const jane = new Person("Jane", "Smith", 25, "Female");
